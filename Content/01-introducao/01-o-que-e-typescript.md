...
> **Versões deste guia:** TypeScript **7.x** e Node.js **20+**. Se algum exemplo não rodar, confira `npx tsc -v` e `node -v` — pode ser recurso novo ou algo que foi depreciado.
...
[Menu](../../README.md#roadmap) · [Próximo: Formas de tipagem →](./02-formas-de-tipagem.md)
